...
import com.vincent.springboot.study.mapper.UserMapper;
...
@SpringBootTest
public class Chapter7MybatisApplicationTests {

    private static final Logger log = LoggerFactory.getLogger(Chapter7MybatisApplicationTests.class);
